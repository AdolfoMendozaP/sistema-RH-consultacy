...
<head>
    ...
    <title>Portal Administrador Consultacy</title>
    ...
    <nav class="navegacion">
            ...
            <li class="title-menu-ig"><span class="fa fa-house icon-menu"></span>Inicio</li>
				<li class="item-submenu" menu="1">
					<a href="#"><span class="fa fa-address-card icon-menu"></span>Panel de control</a>
					<ul class="submenu">
						<li class="title-menu"><span class="fa fa-address-card icon-menu"></span>Panel de control</li>
						<li class="go-back">Atras</li>
						<li><a href="empleados/">Registros de empleados</a></li>
						<li><a href="usuarios/">Registros de usuarios</a></li>
					</ul>
				</li>
				<li><a href="asistencias/"><span class="fa fa-calendar-days icon-menu"></span>Control de asistencias</a></li>
                <li><a href="#"><span class="fa fa-users icon-menu"></span>Desarrollo</a></li>
				<li class="item-submenu" menu="3">
					<a href="#"><span class="fa fa-user-gear icon-menu"></span>Soporte y asistencia</a>
					<ul class="submenu">
						<li class="title-menu"><span class="fa fa-user-gear icon-menu"></span>Soporte y asistencia</li>
						<li class="go-back">Atras</li>
