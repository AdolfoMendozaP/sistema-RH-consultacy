...
try 
{
    ...
    $query = "SELECT personal.fecha_nacimiento, personal.genero, personal.email_personal, personal.telefono, personal.curp, personal.RFC, personal.direccion, personal.NSS, empleado.IDempleado, empleado.nombre, empleado.apellido, empleado.folio
    FROM personal 
    JOIN empleado ON personal.IDempleado = empleado.IDempleado";
...
<header>
    ...
    <div class="container mt-5"> 
     <div class="container mt-4">
        ...
        <a href="index.php" class="btn btn-secondary mb-3 dynamic-button" onclick="mostrarDatosPersonales()">
        ...
        <a href="#" class="btn btn-success mb-3 dynamic-button">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
            <?php foreach ($personal as $personales): ?>
    <tr>
        <td><?php echo $personales['IDempleado']; ?></td>
        <td><?php echo $personales['nombre'] . ' ' . $personales['apellido']; ?></td>
        <td><?php echo $personales['folio']; ?></td>
        <td><?php echo $personales['fecha_nacimiento']; ?></td>
        <td><?php echo $personales['genero']; ?></td>
        <td><?php echo $personales['email_personal']; ?></td>
        <td><?php echo $personales['telefono']; ?></td>
        <td><?php echo $personales['curp']; ?></td>
        <td><?php echo $personales['RFC']; ?></td>
        <td><?php echo $personales['direccion']; ?></td>
        <td><?php echo $personales['NSS']; ?></td>
        </td>
    </tr>
<?php endforeach; ?>
            </tbody>
